  ...
  <div class="Moives">
    ...
    <div class="bottom-section">
      <div class="bottom-section-title">
        <span>Recommendation {{  itemTitle}}</span>
      </div>
...
const itemTitle=ref("")
itemTitle.value=String(store.getters.getActiveSubMenu).substring(0,1).toUpperCase()+String(store.getters.getActiveSubMenu).substring(1)
